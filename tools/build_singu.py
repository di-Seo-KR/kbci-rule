...
NEW={
 ...
 "제16조(규정의 구분)":("제16조(규정의 구분) ① 규정은 다음 각 호의 구분에 따라 제정한다. 1. 규정 : 회사의 경영·조직·관리·영업 등에 관한 기본적 사항을 정하며, 형식은 규정명·본칙·부칙으로 구분하며, 「별표」의 규정 작성형식에 따른다. 2. 지침 : 규정의 시행에 관한 구체적 사항, 규정을 보충하는 사항, 그 밖에 업무수행에 필요한 처리기준·절차 등 중요한 사항을 정한다. ② 외규를 시행하기 위하여 필요한 경우에는 그 내용에 따라 규정 또는 지침으로 정할 수 있다.",
 ...
 "제28조(표)":("제28조(별표) ① 본문에 직접 넣기 어려운 표·서식·도면·별첨 등의 자료는 『별표』로 하여 부칙 다음에 배열한다. ② 간단한 표나 도면은 본칙의 조문 안에 표시할 수 있다.",
   "[별표 통합 ★] 표·서식(별지서식)·도면(별도)을 ‘별표’로 통합, 제29·30조를 본조로 통합"),
 "제29조(서식)":("〈삭제〉","[통합] 서식(별지서식)을 제28조(별표)로 통합 → 삭제"),
 "제30조(도면)":("〈삭제〉","[통합] 도면(별도)을 제28조(별표)로 통합 → 삭제"),
}
# 신설(정본)
EXTRA=[("〈신설〉","제○조(정본 및 열람) ① 「사규관리시스템」에 등재된 사규를 정본(正本)으로 하며, 그 내용이 인쇄물 등 다른 사본과 다를 때에는 정본에 따른다. ② 임직원은 사규관리시스템을 통하여 사규를 열람한다.","[시스템·신설] 정본 채택(승인). 제15조 삭제분(열람) 흡수"),
 ("〈신설〉","제○조(별표 및 부록의 구분) ① “별표”란 사규의 내용을 보충하기 위하여 사규에 첨부하는 표·서식·도면·별첨 등을 말한다. ② “부록”이란 별표 외에 참고로 사규에 첨부하는 자료를 말한다.","[신설·제3장 재정립 ★] 제3장을 ‘서식’→‘별표 및 부록’으로(별표=표·서식·별첨 / 부록=그 외)"),
