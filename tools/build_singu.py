...
NEW={
 ...
 "제9조(시달절차)":("제9조(공포 절차) ① 주무부서장은 등록을 마친 사규를 공포하되, 규정은 대표이사 명의로, 지침은 전결권자 명의로 한다. ② 사규를 공포하는 경우에는 제정·개정·폐지의 사유를 간략히 명시하여야 하며, 필요에 따라 다음 사항을 따로 통지할 수 있다. 1. 규정의 해설 2. 규정의 시행에 필요한 조치와 그 밖의 준비사항",
 ...
 "제10조(효력발생일)":("제10조(효력발생일) 규정의 효력은 원칙적으로 시행일부터 발생한다. 다만, 시행일을 따로 정하지 않은 경우에는 공포일부터 효력이 발생한다.",
   "[정합성·표현] ‘문서 시달일’→‘공포일’(제9조 공포와 정합), 아니한→않은"),
