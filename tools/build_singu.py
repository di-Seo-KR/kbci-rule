...
NEW={
 ...
 "제2조(용어의 정의)":("제2조(용어의 정의) 이 규정에서 사용하는 용어의 뜻은 다음과 같다. 1. “규정”이란 계속적인 구속력을 가지는 규범을 조문 형식으로 정한 것을 말한다. 2. “지침”이란 규정의 시행이나 보충에 필요한 사항을 조문 형식으로 정한 것으로서 계속적인 구속력을 가지는 것을 말한다. 3. “외규”란 법령이나 법령에 따라 발령된 명령·규칙, 감독기관의 규정·지침 등 계속적인 구속력을 가지는 규범을 말한다. 4. “서식”이란 업무상 계속 사용하는 보고서·장부·전표·계약서류 등 일정한 양식의 사무용지를 말한다. 5. “전부개정”이란 기존 조문의 3분의 2 이상을 개정하거나, 여러 차례 개정으로 삭제·추가된 조문이 많아 정비할 필요가 있는 경우의 규정 개정방식을 말한다.",
   "[가독성·정합성] ★‘지침’ 순환정의(‘규정 이외에’)→시행·보충 기능으로 적극 정의, ‘외규’ 발하여진→발령된, ~라 함은→~란, 성문화 풀어쓰기"),
