...
NOTES = {
    ...
    5: "조번호 이동(구 제4조), '인사발령에 의하며'→'인사발령으로 하며'",
    6: "본문 안 직급 구분표를 [별표 제3호]로 이동(「사규관리규정」 제11조제2항). 표 내용 변경 없음",
    7: "'제평가/재평가' 혼용→'제평가' 통일 〈확인 요망〉. ④ 자기 규정 인용 정비(인사규정 제32조 제1항→제33조제1항)",
    8: "근속년수→근속연수(맞춤법), '각 호의 1'→'각 호의 어느 하나'",
    9: "조번호 이동(구 제8조)",
    10: "'심의를 위하여'→'심의하기 위하여'",
    11: "'자'→'사람', '의한다'→'따른다'",
    12: "표제 '채용금지자'→'채용 결격사유'(인용 사규와 정합). 2호 『국가공무원법』 제33조 현행화(구법 '제1항' 삭제 반영), 법령 겹낫표",
    13: "호별 '학력 인정자' 표기 통일",
    14: "'입사일로부터'→'입사일부터'",
    15: "'5~42호으로' 오타 교정 → '5호봉부터 42호봉까지'",
    16: "'징계에 의한'→'징계에 따른', 내부 인용 갱신(제7조②→제8조②)",
    17: "사규 낫표 「보수 및 퇴직금 규정」, '불구하고' 정비",
    18: "'회사명예 거양'→'회사의 명예를 높이는 데', '기타'→'그 밖에'",
    19: "⑤ 최저호봉 참조를 [별표 제3호]로 변경, '한하며'→'한정하여'",
    20: "'당해'→'해당', '도래'→'도달', '익월 초일'→'다음 달 1일', '단'→'다만', 내부 인용 「인사규정 시행지침」 낫표",
    21: "자기 규정 인용 '「인사규정」'→'이 규정'",
    22: "표현 정비",
    23: "내부 인용 갱신(제19조→제20조)",
    24: "조번호 이동(구 제23조)",
    25: "'회사 형편상'→'경영상', '타부점'→'다른 부점'",
    26: "조번호 이동(구 제25조)",
    27: "'일신상 또는 기타의 사유'→'일신상 사유 등'",
    28: "'정년에 달한'→'정년에 도달한', 쉼표 보정",
    29: "4호 금치산·한정치산→피성년후견인·피한정후견인(민법 개정 반영), 10호 「사고금 정리 규정」 낫표, '각 호의 1'→'각 호의 어느 하나'",
    30: "문장 끝 마침표 보정",
    31: "법령 겹낫표 『 』 통일",
    32: "쉼표·띄어쓰기 정비",
